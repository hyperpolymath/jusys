...
:experimental:
:url-github: https://github.com/hyperpolymath/jusys
:url-gitlab: https://gitlab.com/hyperpolymath/jusys
:url-bitbucket: https://bitbucket.org/hyperpolymath/jusys
:url-codeberg: https://codeberg.org/hyperpolymath/jusys

Just-in-time system administration toolkit
...
jusys is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
